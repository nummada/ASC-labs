...
// __global__ void swap_arrays(const float *a, const float *b, int N) {
...
int main(void) {
    ...
    // device_array_b => 32M
    // device_array_c => 2M
    cudaMalloc((void **) &device_array_a, BUF_32M * sizeof(int));
    cudaMalloc((void **) &device_array_b, BUF_32M * sizeof(int));
